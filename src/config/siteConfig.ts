...
export const siteConfig: SiteConfig = {
	title: "Miikka's Archive",
	subtitle: "Welcome to Miikka's Archive",
	siteURL: "https://Miikka11212.github.io/Mizuki/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "700287", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	banner: {
		...
		homeText: {
			...
			subtitle: ["Notes, projects, and records from the everyday."],
			typewriter: {
